...
import { X, HelpCircle, Info, DollarSign, TrendingUp, Users } from 'lucide-react';
    ...
    >
      <motion.div
        ...
        style={{
          ...
          backgroundColor: '#111', color: '#fff', borderRadius: '24px 24px 0 0',
          padding: '24px', paddingTop: 'calc(max(var(--safe-top, 0px), 16px) + 40px)',
        }}
      >
