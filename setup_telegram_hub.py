...
BOT_TOKEN = "5645675988:AAHF1yNU6EdmSp6FYlM2y9YjV2heTk0ke-c"
        ...
        for name, desc in topics.items():
            try:
                ...
                await bot.send_message(
                    chat_id=chat_id,
                    message_id=topic.forum_topic_id, # Using message_id for topic_id in some versions or specific params
