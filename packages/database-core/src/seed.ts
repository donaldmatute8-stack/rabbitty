...
export async function seed() {
  ...
  const sampleUsers = [
    { id: "u1", telegramId: "100001", username: "alice", firstName: "Alice", lastName: "García", email: "alice@test.me", levelId: "l2", totalBunzEarned: 500, totalBunzSpent: 100, visitedBusinesses: 3, role: "USER", hasMadeFirstTransaction: true, hasEarnedFirstBunz: true, hops: 12 },
    { id: "u2", telegramId: "100002", username: "bob", firstName: "Bob", lastName: "Pérez", email: "bob@test.me", levelId: "l1", totalBunzEarned: 200, totalBunzSpent: 50, visitedBusinesses: 2, role: "USER", hasMadeFirstTransaction: true, hasEarnedFirstBunz: true, hops: 5 },
    { id: "u3", telegramId: "100003", username: "carol", firstName: "Carol", lastName: "López", email: "carol@test.me", levelId: "l1", totalBunzEarned: 50, totalBunzSpent: 0, visitedBusinesses: 1, role: "USER", hasMadeFirstTransaction: false, hasEarnedFirstBunz: true, hops: 2 },
    { id: "u4", telegramId: "100004", username: "dave", firstName: "Dave", lastName: "Martínez", email: "dave@test.me", levelId: "l1", totalBunzEarned: 0, totalBunzSpent: 0, visitedBusinesses: 0, role: "USER", hasMadeFirstTransaction: false, hasEarnedFirstBunz: false, hops: 0 },
    { id: "u5", telegramId: "100005", username: "eve", firstName: "Eve", lastName: "Rodríguez", email: "eve@test.me", levelId: "l2", totalBunzEarned: 1000, totalBunzSpent: 300, visitedBusinesses: 5, role: "USER", hasMadeFirstTransaction: true, hasEarnedFirstBunz: true, hops: 20 },
  ];
