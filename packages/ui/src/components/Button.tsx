    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === "secondary" && "bg-white/80 dark:bg-white/10 backdrop-blur-md text-gray-900 dark:text-white hover:bg-white dark:hover:bg-white/20 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-md",
          variant === "ghost" && "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-white",
